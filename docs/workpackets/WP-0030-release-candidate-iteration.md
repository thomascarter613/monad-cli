...
id: WP-0030
title: Release Candidate Iteration
slug: release-candidate-iteration
...
Prepare, validate, and tag v1.0.0 release candidates after all stabilization passes.
...
### TASK-0030.1: Create RC plan

**Purpose:** Complete the `Create RC plan` portion of this work packet.
...
- `Create RC plan` is implemented or fully specified according to this packet.
...
### TASK-0030.2: Run release checks

**Purpose:** Complete the `Run release checks` portion of this work packet.
...
- `Run release checks` is implemented or fully specified according to this packet.
- Changes are understandable to human and AI implementers.
- The repository remains valid and testable.
...
### TASK-0030.3: Fix RC blockers

**Purpose:** Complete the `Fix RC blockers` portion of this work packet.
...
- `Fix RC blockers` is implemented or fully specified according to this packet.
- Changes are understandable to human and AI implementers.
- The repository remains valid and testable.
...
### TASK-0030.5: Document known limitations

**Purpose:** Complete the `Document known limitations` portion of this work packet.
...
- `Document known limitations` is implemented or fully specified according to this packet.
- Changes are understandable to human and AI implementers.
- The repository remains valid and testable.
...
|---|---|---|---|
| SUBTASK-0030.1.1 | TASK-0030.1 | Execute Create RC plan | Task outcome is implemented, documented, and validated. |
| SUBTASK-0030.2.1 | TASK-0030.2 | Execute Run release checks | Task outcome is implemented, documented, and validated. |
| SUBTASK-0030.3.1 | TASK-0030.3 | Execute Fix RC blockers | Task outcome is implemented, documented, and validated. |
| SUBTASK-0030.4.1 | TASK-0030.4 | Execute Update changelog | Task outcome is implemented, documented, and validated. |
| SUBTASK-0030.5.1 | TASK-0030.5 | Execute Document known limitations | Task outcome is implemented, documented, and validated. |
