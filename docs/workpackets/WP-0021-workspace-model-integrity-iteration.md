...
id: WP-0021
title: Workspace Model Integrity Iteration
slug: workspace-model-integrity-iteration
...
labels:
  - v1
  - monad
  - workspace-model-integrity-iteration
...
Prove Monad understands workspace manifests, unit IDs, paths, defaults, packs, policies, and lock/state files correctly.

## 2. Outcome Summary

After this work packet is complete:

- Workspace model is robust.
- Defaults are enforced.
- Malformed workspaces fail cleanly.
...
1. Audit manifest parser
2. Audit defaults
3. Audit root discovery
4. Audit selectors
5. Add malformed fixture tests

## 10. Tasks


### TASK-0021.1: Audit manifest parser

**Purpose:** Complete the `Audit manifest parser` portion of this work packet.
...
- `Audit manifest parser` is implemented or fully specified according to this packet.
...
### TASK-0021.2: Audit defaults

**Purpose:** Complete the `Audit defaults` portion of this work packet.
...
- `Audit defaults` is implemented or fully specified according to this packet.
- Changes are understandable to human and AI implementers.
- The repository remains valid and testable.
...
### TASK-0021.3: Audit root discovery

**Purpose:** Complete the `Audit root discovery` portion of this work packet.
...
- `Audit root discovery` is implemented or fully specified according to this packet.
- Changes are understandable to human and AI implementers.
- The repository remains valid and testable.
...
### TASK-0021.4: Audit selectors

**Purpose:** Complete the `Audit selectors` portion of this work packet.
...
- `Audit selectors` is implemented or fully specified according to this packet.
- Changes are understandable to human and AI implementers.
- The repository remains valid and testable.
...
### TASK-0021.5: Add malformed fixture tests

**Purpose:** Complete the `Add malformed fixture tests` portion of this work packet.
...
- `Add malformed fixture tests` is implemented or fully specified according to this packet.
- Changes are understandable to human and AI implementers.
- The repository remains valid and testable.
...
|---|---|---|---|
| SUBTASK-0021.1.1 | TASK-0021.1 | Execute Audit manifest parser | Task outcome is implemented, documented, and validated. |
| SUBTASK-0021.2.1 | TASK-0021.2 | Execute Audit defaults | Task outcome is implemented, documented, and validated. |
| SUBTASK-0021.3.1 | TASK-0021.3 | Execute Audit root discovery | Task outcome is implemented, documented, and validated. |
| SUBTASK-0021.4.1 | TASK-0021.4 | Execute Audit selectors | Task outcome is implemented, documented, and validated. |
| SUBTASK-0021.5.1 | TASK-0021.5 | Execute Add malformed fixture tests | Task outcome is implemented, documented, and validated. |
