...
id: WP-0007
title: monad add and monad generate
slug: monad-add-and-monad-generate
...
Implement workspace unit addition and generic generation for useful app, service, package, lib, docs, policy, and agent scaffolds.

## 2. Outcome Summary

After this work packet is complete:

- monad add creates useful units.
- Generated stubs are not sparse.
- Manifest updates are safe.
...
1. Implement add unit dispatch
2. Generate useful scaffolds
3. Update manifest
4. Update native configs through plans
5. Add golden tests

## 10. Tasks


### TASK-0007.1: Implement add unit dispatch

**Purpose:** Complete the `Implement add unit dispatch` portion of this work packet.
...
- `Implement add unit dispatch` is implemented or fully specified according to this packet.
...
### TASK-0007.2: Generate useful scaffolds

**Purpose:** Complete the `Generate useful scaffolds` portion of this work packet.
...
- `Generate useful scaffolds` is implemented or fully specified according to this packet.
- Changes are understandable to human and AI implementers.
- The repository remains valid and testable.
...
### TASK-0007.3: Update manifest

**Purpose:** Complete the `Update manifest` portion of this work packet.
...
- `Update manifest` is implemented or fully specified according to this packet.
- Changes are understandable to human and AI implementers.
- The repository remains valid and testable.
...
### TASK-0007.4: Update native configs through plans

**Purpose:** Complete the `Update native configs through plans` portion of this work packet.
...
- `Update native configs through plans` is implemented or fully specified according to this packet.
- Changes are understandable to human and AI implementers.
- The repository remains valid and testable.
...
|---|---|---|---|
| SUBTASK-0007.1.1 | TASK-0007.1 | Execute Implement add unit dispatch | Task outcome is implemented, documented, and validated. |
| SUBTASK-0007.2.1 | TASK-0007.2 | Execute Generate useful scaffolds | Task outcome is implemented, documented, and validated. |
| SUBTASK-0007.3.1 | TASK-0007.3 | Execute Update manifest | Task outcome is implemented, documented, and validated. |
| SUBTASK-0007.4.1 | TASK-0007.4 | Execute Update native configs through plans | Task outcome is implemented, documented, and validated. |
| SUBTASK-0007.5.1 | TASK-0007.5 | Execute Add golden tests | Task outcome is implemented, documented, and validated. |
