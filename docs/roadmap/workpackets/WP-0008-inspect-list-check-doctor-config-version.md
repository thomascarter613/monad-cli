...
id: WP-0008
title: Inspect List Check Doctor Config Version
slug: inspect-list-check-doctor-config-version
...
labels:
  - v1
  - monad
  - inspect-list-check-doctor-config-version
...
Implement core read, validation, diagnostics, configuration, and version commands for existing workspaces.
...
- Version output includes schema versions.
...
### TASK-0008.1: Implement list

**Purpose:** Complete the `Implement list` portion of this work packet.
...
- `Implement list` is implemented or fully specified according to this packet.
...
### TASK-0008.2: Implement inspect

**Purpose:** Complete the `Implement inspect` portion of this work packet.
...
- `Implement inspect` is implemented or fully specified according to this packet.
- Changes are understandable to human and AI implementers.
- The repository remains valid and testable.
...
### TASK-0008.3: Implement check

**Purpose:** Complete the `Implement check` portion of this work packet.
...
- `Implement check` is implemented or fully specified according to this packet.
- Changes are understandable to human and AI implementers.
- The repository remains valid and testable.
...
### TASK-0008.4: Implement doctor

**Purpose:** Complete the `Implement doctor` portion of this work packet.
...
- `Implement doctor` is implemented or fully specified according to this packet.
- Changes are understandable to human and AI implementers.
- The repository remains valid and testable.
...
### TASK-0008.5: Implement config

**Purpose:** Complete the `Implement config` portion of this work packet.
...
- `Implement config` is implemented or fully specified according to this packet.
- Changes are understandable to human and AI implementers.
- The repository remains valid and testable.
...
### TASK-0008.6: Implement version

**Purpose:** Complete the `Implement version` portion of this work packet.
...
- `Implement version` is implemented or fully specified according to this packet.
- Changes are understandable to human and AI implementers.
- The repository remains valid and testable.
...
|---|---|---|---|
| SUBTASK-0008.1.1 | TASK-0008.1 | Execute Implement list | Task outcome is implemented, documented, and validated. |
| SUBTASK-0008.2.1 | TASK-0008.2 | Execute Implement inspect | Task outcome is implemented, documented, and validated. |
| SUBTASK-0008.3.1 | TASK-0008.3 | Execute Implement check | Task outcome is implemented, documented, and validated. |
| SUBTASK-0008.4.1 | TASK-0008.4 | Execute Implement doctor | Task outcome is implemented, documented, and validated. |
| SUBTASK-0008.5.1 | TASK-0008.5 | Execute Implement config | Task outcome is implemented, documented, and validated. |
| SUBTASK-0008.6.1 | TASK-0008.6 | Execute Implement version | Task outcome is implemented, documented, and validated. |
