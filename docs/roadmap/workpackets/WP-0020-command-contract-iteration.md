...
id: WP-0020
title: Command Contract Iteration
slug: command-contract-iteration
...
Ensure every command follows consistent flags, help, output, JSON, dry-run, and exit-code behavior.

## 2. Outcome Summary

After this work packet is complete:

- Command behavior is consistent.
- Help is complete.
- Smoke tests cover commands.
...
3. Audit JSON output
4. Audit dry-run
5. Add command catalog tests

## 10. Tasks


### TASK-0020.1: Audit help

**Purpose:** Complete the `Audit help` portion of this work packet.
...
- `Audit help` is implemented or fully specified according to this packet.
...
### TASK-0020.2: Audit flags

**Purpose:** Complete the `Audit flags` portion of this work packet.
...
- `Audit flags` is implemented or fully specified according to this packet.
- Changes are understandable to human and AI implementers.
- The repository remains valid and testable.
...
### TASK-0020.3: Audit JSON output

**Purpose:** Complete the `Audit JSON output` portion of this work packet.
...
- `Audit JSON output` is implemented or fully specified according to this packet.
- Changes are understandable to human and AI implementers.
- The repository remains valid and testable.
...
### TASK-0020.4: Audit dry-run

**Purpose:** Complete the `Audit dry-run` portion of this work packet.
...
- `Audit dry-run` is implemented or fully specified according to this packet.
- Changes are understandable to human and AI implementers.
- The repository remains valid and testable.
...
### TASK-0020.5: Add command catalog tests

**Purpose:** Complete the `Add command catalog tests` portion of this work packet.
...
- `Add command catalog tests` is implemented or fully specified according to this packet.
- Changes are understandable to human and AI implementers.
- The repository remains valid and testable.
...
|---|---|---|---|
| SUBTASK-0020.1.1 | TASK-0020.1 | Execute Audit help | Task outcome is implemented, documented, and validated. |
| SUBTASK-0020.2.1 | TASK-0020.2 | Execute Audit flags | Task outcome is implemented, documented, and validated. |
| SUBTASK-0020.3.1 | TASK-0020.3 | Execute Audit JSON output | Task outcome is implemented, documented, and validated. |
| SUBTASK-0020.4.1 | TASK-0020.4 | Execute Audit dry-run | Task outcome is implemented, documented, and validated. |
| SUBTASK-0020.5.1 | TASK-0020.5 | Execute Add command catalog tests | Task outcome is implemented, documented, and validated. |
