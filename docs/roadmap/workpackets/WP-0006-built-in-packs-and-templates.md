...
id: WP-0006
title: Built-in Packs and Templates
slug: built-in-packs-and-templates
...
Define built-in packs and template behavior for the first v1 language, docs, policy, CI, and Docker capabilities.

## 2. Outcome Summary

After this work packet is complete:

- Built-in packs are listable.
- Templates are inspectable.
- Pack v1 scope is clear.
...
1. Define pack model
2. Add built-in pack metadata
3. Add template listing
4. Add template inspection
5. Document plugin limitations

## 10. Tasks


### TASK-0006.1: Define pack model

**Purpose:** Complete the `Define pack model` portion of this work packet.
...
- `Define pack model` is implemented or fully specified according to this packet.
...
### TASK-0006.2: Add built-in pack metadata

**Purpose:** Complete the `Add built-in pack metadata` portion of this work packet.
...
- `Add built-in pack metadata` is implemented or fully specified according to this packet.
- Changes are understandable to human and AI implementers.
- The repository remains valid and testable.
...
### TASK-0006.3: Add template listing

**Purpose:** Complete the `Add template listing` portion of this work packet.
...
- `Add template listing` is implemented or fully specified according to this packet.
- Changes are understandable to human and AI implementers.
- The repository remains valid and testable.
...
### TASK-0006.4: Add template inspection

**Purpose:** Complete the `Add template inspection` portion of this work packet.
...
- `Add template inspection` is implemented or fully specified according to this packet.
- Changes are understandable to human and AI implementers.
- The repository remains valid and testable.
...
### TASK-0006.5: Document plugin limitations

**Purpose:** Complete the `Document plugin limitations` portion of this work packet.
...
- `Document plugin limitations` is implemented or fully specified according to this packet.
- Changes are understandable to human and AI implementers.
- The repository remains valid and testable.
...
|---|---|---|---|
| SUBTASK-0006.1.1 | TASK-0006.1 | Execute Define pack model | Task outcome is implemented, documented, and validated. |
| SUBTASK-0006.2.1 | TASK-0006.2 | Execute Add built-in pack metadata | Task outcome is implemented, documented, and validated. |
| SUBTASK-0006.3.1 | TASK-0006.3 | Execute Add template listing | Task outcome is implemented, documented, and validated. |
| SUBTASK-0006.4.1 | TASK-0006.4 | Execute Add template inspection | Task outcome is implemented, documented, and validated. |
| SUBTASK-0006.5.1 | TASK-0006.5 | Execute Document plugin limitations | Task outcome is implemented, documented, and validated. |
